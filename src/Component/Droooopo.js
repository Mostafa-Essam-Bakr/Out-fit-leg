  ...
  return (
    ...
    >
      ...
      >
        ...
        <Option setOpen={setOpen} Icon={FiHeart} text="Extra Heart" />
        <Option setOpen={setOpen} Icon={FiGift} text="Gifts" />
        <Option setOpen={setOpen} Icon={FiShoppingCart} text="Markets" />
      </motion.ul>
    </motion.div>
  );
};
